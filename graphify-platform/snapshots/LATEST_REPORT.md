...
## Corpus Check
- 325 files · ~268,633 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1612 nodes · 3079 edges · 96 communities detected
...
Cohesion: 0.03
Nodes (82): CointelegraphRssAdapter, extractSymbols(), extractTag(), extractTopics(), parseRssItems(), acquireTradeLock(), addDecision(), addGladiatorDna() (+74 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (38): TheButcher, wilsonLower(), runDailyRotation(), getGladiatorDna(), getGladiatorsFromDb(), refreshGladiatorsFromCloud(), saveGladiatorsToDb(), callLLMForDNA() (+30 more)
...
Cohesion: 0.06
Nodes (45): MexcAdapter, getResilientPrice(), getLivePositions(), updateLivePosition(), executeMexcTrade(), getExchangeInfoCached(), getPositionSize(), getSymbolFilters() (+37 more)
...
Cohesion: 0.05
Nodes (41): appendToEquityCurve(), getBotConfig(), getDecisions(), getEquityCurve(), getSyncQueueStats(), saveBotConfig(), extractWinningBehaviors(), emitDemotion() (+33 more)
...
Cohesion: 0.06
Nodes (16): _resetLlmCostForTests(), buildFeatureVector(), encodeRegime(), heuristicPredict(), MicroML, MonteCarloEngine, card(), hBg() (+8 more)
...
- **Thin community `Community 83`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 84`** (1 nodes): `predictor.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
