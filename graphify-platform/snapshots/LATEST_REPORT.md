...
## Corpus Check
- 312 files · ~255,741 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1571 nodes · 3024 edges · 99 communities detected
- Extraction: 70% EXTRACTED · 30% INFERRED · 0% AMBIGUOUS · INFERRED: 921 edges (avg confidence: 0.8)
...
Cohesion: 0.02
Nodes (90): calculateAdaptiveSize(), errorResponse(), successResponse(), captureDivisionSnapshot(), captureSnapshot(), persistAsync(), persistDivAsync(), recentDivisionSnapshots() (+82 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (44): TheButcher, wilsonLower(), computeDegradation(), computeStats(), getCpcvConfig(), getCpcvMode(), isFoldOverfit(), loadTrades() (+36 more)
...
Cohesion: 0.04
Nodes (41): getResilientPrice(), releaseTaskLease(), tryAcquireTaskLease(), GladiatorRegistry, recordProviderHealth(), MemoryCache, buildAllSettlementStats(), buildDivisionSummaries() (+33 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (32): callLLM(), costUsd(), isAbortError(), priceFor(), recordCall(), CoindeskRssAdapter, extract(), extractSymbols() (+24 more)
...
Cohesion: 0.06
Nodes (45): MexcAdapter, addInvalidSymbol(), isSymbolValid(), updateLivePosition(), executeMexcTrade(), getExchangeInfoCached(), getPositionSize(), getSymbolFilters() (+37 more)
...
Cohesion: 0.06
Nodes (50): addGladiatorDna(), addGladiatorDnaBatch(), appendToEquityCurve(), AsyncMutex, buildWashKeyMap(), clearSystemHealthData(), flushPendingSyncs(), getCrossGladiatorWashScore() (+42 more)
...
Cohesion: 0.08
Nodes (21): addSyndicateAudit(), buildBearPrompt(), buildBullPrompt(), callLLM(), DebateEngine, heuristicDebate(), parseArgument(), scoreDebate() (+13 more)
...
Cohesion: 0.21
Nodes (6): getGladiatorDna(), DNAExtractor, modeFromBattleId(), readHoldSeconds(), recordPnlPercent(), safeObserve()
...
- **Thin community `Community 64`** (2 nodes): `SwRegister.tsx`, `handleUpdate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (2 nodes): `badgesEnabled()`, `ExplainCard.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (2 nodes): `volumeIntel.ts`, `classifyVolume()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (2 nodes): `instrumentCron()`, `cronInstrument.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 88`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (1 nodes): `polyTypes.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (1 nodes): `seedStrategies.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (1 nodes): `gladiator.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 94`** (1 nodes): `strategy.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 95`** (1 nodes): `radar.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (1 nodes): `scoringConfig.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 97`** (1 nodes): `page.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 98`** (1 nodes): `route.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `GET()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 31`?**
  _High betweenness centrality (0.535) - this node is a cross-community bridge._
- **Why does `POST()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 23`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `fetchWithRetry()` connect `Community 5` to `Community 0`, `Community 9`, `Community 2`?**
