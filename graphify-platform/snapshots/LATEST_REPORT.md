...
## Corpus Check
- 331 files · ~271,260 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1635 nodes · 3116 edges · 103 communities detected
...
Cohesion: 0.02
Nodes (99): calculateAdaptiveSize(), errorResponse(), successResponse(), captureDivisionSnapshot(), captureSnapshot(), persistAsync(), persistDivAsync(), recentDivisionSnapshots() (+91 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (71): acquireTradeLock(), addDecision(), addGladiatorDna(), addGladiatorDnaBatch(), addLivePosition(), appendToEquityCurve(), AsyncMutex, buildWashKeyMap() (+63 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (43): TheButcher, wilsonLower(), computeDegradation(), computeStats(), getCpcvConfig(), getCpcvMode(), isFoldOverfit(), loadTrades() (+35 more)
...
Cohesion: 0.05
Nodes (51): MexcAdapter, getResilientPrice(), addInvalidSymbol(), isSymbolValid(), updateLivePosition(), updatePostTrade(), executeMexcTrade(), getExchangeInfoCached() (+43 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (43): alertBetPlaced(), alertBetResolved(), alertDailyDigest(), alertRiskHalt(), isRateLimited(), sendTelegramAlert(), TELEGRAM_BOT_TOKEN(), TELEGRAM_CHAT_ID() (+35 more)
...
Cohesion: 0.06
Nodes (24): buildBearPrompt(), buildBullPrompt(), callLLM(), DebateEngine, heuristicDebate(), parseArgument(), scoreDebate(), flushBuffer() (+16 more)
...
Cohesion: 0.1
Nodes (41): costUsd(), ensureEntry(), getLlmCostSnapshot(), getMarketCost(), isEnabled(), priceFor(), purgeExpired(), recordLlmCall() (+33 more)
...
Cohesion: 0.09
Nodes (34): loadPolyLastScansFromCloud(), loadPolyStateFromCloud(), savePolyGladiatorsToCloud(), savePolyWalletToCloud(), spawnPolyGladiator(), deserializeWallet(), _doInit(), ensureInitialized() (+26 more)
...
- **Thin community `Community 73`** (2 nodes): `route.ts`, `classifyPost()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (2 nodes): `useRealtimeData.ts`, `useRealtimeData()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (2 nodes): `useBotStats.ts`, `useBotStats()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (1 nodes): `KpiBar.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (1 nodes): `TradingViewChart.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 78`** (1 nodes): `MoltbookSwarmFeed.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 79`** (1 nodes): `DragonLogo.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 80`** (1 nodes): `Sparkline.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (1 nodes): `EquityCurve.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 82`** (1 nodes): `SectorInfo.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 83`** (1 nodes): `SyndicateFeed.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 89`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (1 nodes): `predictor.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `GET()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 26`, `Community 30`?**
  _High betweenness centrality (0.547) - this node is a cross-community bridge._
- **Why does `POST()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 18`, `Community 22`, `Community 26`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `getAggregatedTokens()` connect `Community 11` to `Community 0`, `Community 12`, `Community 6`?**
