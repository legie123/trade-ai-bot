...
## Corpus Check
- 325 files · ~264,990 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1601 nodes · 3043 edges · 99 communities detected
- Extraction: 70% EXTRACTED · 30% INFERRED · 0% AMBIGUOUS · INFERRED: 905 edges (avg confidence: 0.8)
...
Cohesion: 0.04
Nodes (63): CointelegraphRssAdapter, extractSymbols(), extractTag(), extractTopics(), parseRssItems(), addGladiatorDna(), addGladiatorDnaBatch(), addLivePosition() (+55 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (36): TheButcher, wilsonLower(), runDailyRotation(), getGladiatorBattles(), getGladiatorDna(), refreshGladiatorsFromCloud(), saveGladiatorsToDb(), callLLMForDNA() (+28 more)
...
Cohesion: 0.05
Nodes (43): getResilientPrice(), releaseTaskLease(), tryAcquireTaskLease(), GladiatorRegistry, MemoryCache, buildAllSettlementStats(), buildDivisionSummaries(), buildFactorDrift() (+35 more)
...
Cohesion: 0.07
Nodes (11): flushBuffer(), forceFlush(), generateId(), logDecision(), startFlushTimer(), updatePostTrade(), uuid(), computeInsight() (+3 more)
...
- **Thin community `Community 89`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (1 nodes): `gladiatorStore.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `POST()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 25`, `Community 27`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `DELETE()` connect `Community 6` to `Community 0`, `Community 2`, `Community 8`, `Community 11`, `Community 15`, `Community 16`, `Community 19`, `Community 20`, `Community 23`, `Community 26`?**
...
- **Are the 78 inferred relationships involving `POST()` (e.g. with `.getCurrentSynthesis()` and `.getModifierForSymbol()`) actually correct?**
  _`POST()` has 78 INFERRED edges - model-reasoned connections that need verification._
