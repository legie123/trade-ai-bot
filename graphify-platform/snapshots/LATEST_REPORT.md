...
## Corpus Check
- 335 files · ~272,440 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1645 nodes · 3125 edges · 107 communities detected
...
Cohesion: 0.02
Nodes (108): calculateAdaptiveSize(), errorResponse(), successResponse(), binanceRequest(), getBinanceBalances(), getBinanceConfig(), getBinancePrice(), placeBinanceMarketOrder() (+100 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (64): CointelegraphRssAdapter, extractSymbols(), extractTag(), extractTopics(), parseRssItems(), acquireTradeLock(), addDecision(), addGladiatorDna() (+56 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (39): TheButcher, wilsonLower(), runDailyRotation(), getGladiatorsFromDb(), initDB(), refreshGladiatorsFromCloud(), requireDb(), saveGladiatorsToDb() (+31 more)
...
Cohesion: 0.06
Nodes (44): MexcAdapter, addInvalidSymbol(), isSymbolValid(), updateLivePosition(), updatePostTrade(), executeMexcTrade(), getExchangeInfoCached(), getPositionSize() (+36 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (40): getBotConfig(), getDecisions(), getEquityCurve(), getLivePositions(), getSyncQueueStats(), extractWinningBehaviors(), emitDemotion(), emitError() (+32 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (37): getResilientPrice(), GladiatorRegistry, buildAllSettlementStats(), buildDivisionSummaries(), buildFactorDrift(), buildGladiatorActivity(), buildSettlementStats(), buildWeeklyReport() (+29 more)
...
Cohesion: 0.06
Nodes (12): getGladiatorBattles(), computeInsight(), ExperienceCache, ExperienceMemory, OmegaEngine, SwarmOrchestrator, aggregateStats(), bootstrapPValueOosPositive() (+4 more)
...
Cohesion: 0.09
Nodes (34): computeDegradation(), computeStats(), getCpcvConfig(), getCpcvMode(), isFoldOverfit(), loadTrades(), parseTsMs(), runCpcvValidate() (+26 more)
...
- **Thin community `Community 55`** (2 nodes): `Sidebar.tsx`, `Sidebar()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (2 nodes): `LoadingStates.tsx`, `Skeleton()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 57`** (2 nodes): `SentinelCouplingPanel.tsx`, `decisionColor()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (2 nodes): `AppShell()`, `AppShell.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (2 nodes): `pnlCol()`, `DivisionTunerPanel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (2 nodes): `Toast.tsx`, `useToast()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (2 nodes): `DirectionBadge()`, `DecisionMatrix.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (2 nodes): `PaperBacktestPanel.tsx`, `pnlColor()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 63`** (2 nodes): `GoldDust()`, `GoldDust.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 64`** (2 nodes): `SwRegister.tsx`, `handleUpdate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (2 nodes): `SectionHeader.tsx`, `SectionHeader()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (2 nodes): `resolveTheme()`, `GrafanaPanel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (2 nodes): `StatusChip.tsx`, `StatusChip()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (2 nodes): `badgesEnabled()`, `ExplainCard.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (2 nodes): `volumeIntel.ts`, `classifyVolume()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (2 nodes): `instrumentCron()`, `cronInstrument.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (2 nodes): `page.tsx`, `Home()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (2 nodes): `DeepSeekStatus()`, `DeepSeekStatus.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (2 nodes): `page.tsx`, `deriveAgentState()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (2 nodes): `route.ts`, `classifyPost()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (2 nodes): `useRealtimeData.ts`, `useRealtimeData()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (2 nodes): `useBotStats.ts`, `useBotStats()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (1 nodes): `KpiBar.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 78`** (1 nodes): `TradingViewChart.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 79`** (1 nodes): `MoltbookSwarmFeed.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 80`** (1 nodes): `DragonLogo.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (1 nodes): `Sparkline.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 82`** (1 nodes): `EquityCurve.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 83`** (1 nodes): `SectorInfo.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 84`** (1 nodes): `SyndicateFeed.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (1 nodes): `theme.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 90`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (1 nodes): `predictor.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (1 nodes): `polyTypes.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `POST()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 18`, `Community 19`, `Community 22`, `Community 23`?**
