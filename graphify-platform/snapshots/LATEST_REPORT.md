...
## Corpus Check
- 308 files · ~252,835 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1552 nodes · 2985 edges · 97 communities detected
- Extraction: 70% EXTRACTED · 30% INFERRED · 0% AMBIGUOUS · INFERRED: 909 edges (avg confidence: 0.8)
...
Cohesion: 0.02
Nodes (100): calculateAdaptiveSize(), errorResponse(), successResponse(), captureDivisionSnapshot(), captureSnapshot(), persistAsync(), persistDivAsync(), recentDivisionSnapshots() (+92 more)
...
Cohesion: 0.04
Nodes (27): TheButcher, wilsonLower(), runDailyRotation(), getGladiatorsFromDb(), getPhantomTrades(), refreshGladiatorsFromCloud(), removePhantomTrade(), saveGladiatorsToDb() (+19 more)
...
Cohesion: 0.04
Nodes (42): AlphaScout, getResilientPrice(), canPlaceBet(), classifyEdge(), envFloat(), envInt(), getEdgeWatchdogState(), getThresholds() (+34 more)
...
Cohesion: 0.06
Nodes (51): computeDegradation(), computeStats(), getCpcvConfig(), getCpcvMode(), isFoldOverfit(), loadTrades(), parseTsMs(), runCpcvValidate() (+43 more)
...
Cohesion: 0.07
Nodes (28): releaseTaskLease(), tryAcquireTaskLease(), MemoryCache, costUsd(), ensureEntry(), getLlmCostSnapshot(), getMarketCost(), isEnabled() (+20 more)
...
Cohesion: 0.06
Nodes (31): flushBuffer(), forceFlush(), generateId(), logDecision(), startFlushTimer(), updatePostTrade(), uuid(), asNum() (+23 more)
...
Cohesion: 0.11
Nodes (20): emitDemotion(), emitError(), emitEvent(), emitKillSwitch(), emitPromotion(), emitSentinelVeto(), emitTradeExecuted(), getRecentEvents() (+12 more)
...
Cohesion: 0.1
Nodes (19): callLLM(), costUsd(), isAbortError(), priceFor(), recordCall(), getGladiatorDna(), DNAExtractor, modeFromBattleId() (+11 more)
...
Cohesion: 0.1
Nodes (9): calcBollingerBands(), sma(), stdDev(), MonteCarloEngine, card(), hBg(), hColor(), pct() (+1 more)
...
- **Why does `GET()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 29`?**
  _High betweenness centrality (0.517) - this node is a cross-community bridge._
- **Why does `POST()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 19`, `Community 20`?**
  _High betweenness centrality (0.184) - this node is a cross-community bridge._
- **Why does `getAggregatedTokens()` connect `Community 9` to `Community 0`, `Community 1`, `Community 4`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Are the 204 inferred relationships involving `GET()` (e.g. with `isAuthenticated()` and `runKarmaRead()`) actually correct?**
  _`GET()` has 204 INFERRED edges - model-reasoned connections that need verification._
