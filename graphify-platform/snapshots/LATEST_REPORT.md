...
## Summary
- 1646 nodes · 3129 edges · 108 communities detected
- Extraction: 70% EXTRACTED · 30% INFERRED · 0% AMBIGUOUS · INFERRED: 944 edges (avg confidence: 0.8)
...
Cohesion: 0.02
Nodes (64): checkCorrelation(), getCorrelationMatrix(), getPriceHistory(), pearsonCorrelation(), recordPrice(), ensureCorrelationId(), getCurrentCid(), newCorrelationId() (+56 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (39): calculateAdaptiveSize(), errorResponse(), successResponse(), TheButcher, wilsonLower(), runDailyRotation(), requireCronAuth(), getGladiatorDna() (+31 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (71): acquireTradeLock(), addDecision(), addGladiatorDna(), addGladiatorDnaBatch(), addLivePosition(), addPhantomTrade(), appendToEquityCurve(), AsyncMutex (+63 more)
...
Cohesion: 0.05
Nodes (52): MexcAdapter, getResilientPrice(), addInvalidSymbol(), isSymbolValid(), updateLivePosition(), updatePostTrade(), executeMexcTrade(), getExchangeInfoCached() (+44 more)
...
Cohesion: 0.08
Nodes (46): callLLMForDNA(), deterministicCrossover(), dnaSimilarity(), extractDNA(), isDNADuplicate(), isDNASane(), isNearLoser(), miniBacktest() (+38 more)
...
Cohesion: 0.07
Nodes (19): binanceRequest(), getBinanceBalances(), getBinanceConfig(), getBinancePrice(), placeBinanceMarketOrder(), sign(), testBinanceConnection(), getFreshHealthSnapshot() (+11 more)

### Community 15 - "Community 15"
Cohesion: 0.08
Nodes (19): releaseTaskLease(), tryAcquireTaskLease(), MemoryCache, _resetLlmCostForTests(), buildFeatureVector(), encodeRegime(), heuristicPredict(), MicroML (+11 more)
...
Cohesion: 0.09
Nodes (15): callLLM(), costUsd(), isAbortError(), priceFor(), recordCall(), getPhantomTrades(), DNAExtractor, modeFromBattleId() (+7 more)
...
Cohesion: 0.42
Nodes (7): doRefresh(), getLookbackDays(), getSeedBlacklistInfo(), isBlacklistReady(), isEnabled(), isSeedBlacklisted(), refreshSeedBlacklist()
