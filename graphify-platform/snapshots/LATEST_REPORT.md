...
Cohesion: 0.02
Nodes (120): calculateAdaptiveSize(), errorResponse(), successResponse(), captureDivisionSnapshot(), captureSnapshot(), persistAsync(), persistDivAsync(), recentDivisionSnapshots() (+112 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (67): alertBetPlaced(), alertBetResolved(), alertDailyDigest(), alertRiskHalt(), isRateLimited(), sendTelegramAlert(), TELEGRAM_BOT_TOKEN(), TELEGRAM_CHAT_ID() (+59 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (61): MexcAdapter, getResilientPrice(), getEquityCurve(), getLivePositions(), updateLivePosition(), executeMexcTrade(), getExchangeInfoCached(), getPositionSize() (+53 more)
...
Cohesion: 0.04
Nodes (69): CointelegraphRssAdapter, extractSymbols(), extractTag(), extractTopics(), parseRssItems(), acquireTradeLock(), addGladiatorDna(), addGladiatorDnaBatch() (+61 more)
...
Cohesion: 0.06
Nodes (24): callLLM(), costUsd(), isAbortError(), priceFor(), recordCall(), addDecision(), addLivePosition(), getPhantomTrades() (+16 more)
...
Cohesion: 0.09
Nodes (16): AutoDebugEngine, appendToEquityCurve(), getBotConfig(), getDecisions(), saveBotConfig(), extractWinningBehaviors(), emitDemotion(), emitError() (+8 more)
